...
class CarteiraTab(tk.Frame):
    """
    Aba de Carteira: exibe dados resumidos, botões de operação, rendimentos e a tabela de ações.
    """

    def __init__(self, parent, portfolio_manager, update_interval_ms):
    ...
    def create_widgets(self):
        ...
        # Painel Inferior (Tabela de Ações)
    ...
    def refresh(self):
        ...
        self.after(self.update_interval_ms, self.refresh)
